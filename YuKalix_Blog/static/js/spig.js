...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if (e.which === 3) {
            showMessage("秘密通道:<br /><a href=\"https://github.com/YuKalix/YuKalix-Blog\" title=\"本平台源码\">本平台源码</a>", 10000);
        }
    });
...
jQuery(document).ready(function ($) {
    ...
    window.setInterval(function () {
        msgs = ["播报明日天气<iframe name=\"xidie\" src=\"https://www.52ziyu.cn/\"frameborder=\“0\” scrolling=\"no\" height=\"15px\"  width=\"130px\" allowtransparency=\"true\" ></iframe>", "陪我聊天吧！", "<a href=\"http://xx\" target=\"_blank\" rel=\"external\" tip=\"Feed\"><img border=\"0\" title=\"订阅乱了感觉\" alt=\"Feed\" src=\"/wp-content/themes/chromeStyle/images/rss.png\"></a>", "好无聊哦，你都不陪我玩！", "…@……!………", "^%#&*!@*(&#)(!)(", "我可爱吧！嘻嘻!~^_^!~~", "谁淫荡呀?~谁淫荡?，你淫荡呀!~~你淫荡！~~", "从前有座山，山上有座庙，庙里有个老和尚给小和尚讲故事，讲：“从前有座……”"];
        var i = Math.floor(Math.random() * msgs.length);
...
jQuery(document).ready(function ($) {
    window.setInterval(function () {
        msgs = ["播报明日天气<iframe name=\"xidie\" src=\"http://\"frameborder=\“0\” scrolling=\"no\" height=\"15px\"  width=\"130px\" allowtransparency=\"true\" ></iframe>", "快快订阅我的博客吧！<a href=\"http:\" target=\"_blank\" rel=\"external\" tip=\"Feed\"><img border=\"0\" title=\"订阅乱了感觉\" alt=\"Feed\" src=\"/wp-content/themes/chromeStyle/images/rss.png\"></a>", "乾坤大挪移！", "我飘过来了！~", "我飘过去了", "我得意地飘！~飘！~"];
        var i = Math.floor(Math.random() * msgs.length);
...
jQuery(document).ready(function ($) {
    $("#author").click(function () {
        ...
        $(".spig").animate({
                top: $("#form1").offset().top - 70,
                left: $("#form1").offset().left - 170
            },
            {
                queue: false,
                duration: 1000
    ...
    $("#url").click(function () {
        ...
        $(".spig").animate({
                top: $("#lytext").offset().top - 70,
                left: $("#lytext").offset().left - 170
            },
            {
                queue: false,
                duration: 1000
